...
$Relacional =  ObtenerPlatilloRelacional($id);
?>
<html>
	<head>
	...
	<meta charset=utf-8 />
        ...
        .done(function(){
            swal ( "Success" ,  "Costo Correctamente Modificado" ,  "success" );
			//sendFoto();
        })
        .fail(function(){
				...
				<header class="align-center">
                    ...
                    <table>
                        ...
                        echo "<tr>";
                            ...
                            echo "</td>"; 
                            echo "<td align='center'>";
                                echo "<input type='text' id='".$tp['TipoGuisoID']."'";
                                $costog = ObtenerCostoConTipoPlatillo($id,$tp['TipoGuisoID']);
                                    echo "value='".$costog['Costo']."'";
                                echo " onKeyPress='return soloNumeros(event)'>";
                            
                                echo "</td>"; 
                            echo "<td align='center'>";
                                echo "<button onclick='valida(".$tp['TipoGuisoID'].",".$id.")'>Modificar</button>";
                            echo "</td>"; 
                        echo "</tr>";
                        }
                    ?>
